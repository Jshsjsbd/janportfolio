            ...
            <section id="contact" className="relative top-20 z-10 py-24 md:py-36">
                <div className="custom-styles shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] backdrop-blur-[8px] rounded-[1.25rem] max-w-2xl mx-auto px-8 py-12">
                    ...
                    <div className="flex flex-col justify-center items-center">
                        <button type="submit" className="w-6/9 px-6 py-3 bg-gradient-to-r from-teal-400 to-indigo-500 text-lg font-bold text-gray-900 rounded-md hover:from-indigo-500 hover:to-teal-400 transition duration-300">Send Message</button>
                    </div>
                    </form>
                </div>
            </section>
